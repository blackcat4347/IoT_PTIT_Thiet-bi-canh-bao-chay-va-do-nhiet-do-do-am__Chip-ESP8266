...
var pythonScriptPath = 'C:\\WebServer\\modules\\handler\\dulieudoamhuanluyen.py'; // Đường dẫn đến tệp Python

function dudoandoam() {
  var child;
  return regeneratorRuntime.async(function dudoandoam$(_context) {
    while (1) {
